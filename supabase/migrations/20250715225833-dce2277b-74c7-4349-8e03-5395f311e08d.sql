-- Insert next batch of galactic systems (Isht to Kanaver) - Fixed duplicate Junction entries
...
('Junction (Vorc)', 'Vorc', 'Mid Rim', 'J-7'),
('Junction (Thesme)', 'Thesme', 'Outer Rim Territories', 'O-5'),
